...
import com.example.suryaapp.DebitedListFragmentDirections
...
class DebitedAdapter(private val viewModelStoreOwner: ViewModelStoreOwner) :
    RecyclerView.Adapter<DebitedAdapter.ViewHolder>() {

    private var paymentsList= emptyList<Debited>()
                    ...
                    val alertDialogBuilder = AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Yes") { dialog, _ ->
                            ...
                            CoroutineScope(Dispatchers.IO).launch {
                                try {
                                    debitedViewModel.deleteDebited(deletedOrder)
                                } catch (e: Exception) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cardLayout.setOnClickListener{
            val action = DebitedListFragmentDirections.actionDebitedListFragmentToDebitedUpdatedFragment(orderData)
    ...
    fun setData(order:List<Debited>){
