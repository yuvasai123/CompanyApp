...
import com.example.suryaapp.data.expenditurelist.ExpenditureDao
...
@Database(entities = [Order::class,Previous::class,Payments::class, Recipients::class ,Debited::class,Expenditure::class], version = 1, exportSchema = true)
