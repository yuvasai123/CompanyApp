...
class PaymentListFragment : Fragment(),SearchView.OnQueryTextListener {
    ...
    override fun onCreateView(
       ...
       val button = view.findViewById<FloatingActionButton>(R.id.addpayment)
        ...
        paymentsViewModel.readAllPaymentsData.observe(viewLifecycleOwner, Observer { payments ->
    ...
    private fun searchDatabase(query: String) {
        ...
        paymentsViewModel.searchDatabase(searchQuery).observe(viewLifecycleOwner, Observer { list ->
