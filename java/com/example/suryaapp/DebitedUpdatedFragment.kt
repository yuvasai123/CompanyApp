...
class DebitedUpdatedFragment : Fragment() {

    private val args by navArgs<DebitedUpdatedFragmentArgs>()
    ...
    override fun onCreateView(
        ...
        // Set values
        customerName.setText(args.currentDebited.customerName)
        val dateFormatter = SimpleDateFormat("dd-MM-yyyy", Locale.getDefault())
        val dateString = dateFormatter.format(args.currentDebited.date)
        date.text = dateString
        totalamount.setText(args.currentDebited.totalamount)
        modeOfPayment.setText(args.currentDebited.cashtype)
        description.setText(args.currentDebited.paydescription)
    ...
    private fun updateItem() {
        ...
        val updatedOrder = Debited(
            args.currentDebited.id,
            updatedCustomerName,
            updatedDate,
            updatedamount,
        ...
        if (updatedCustomerName.isEmpty()) {
            ...
            debitedViewModel.updateDebited(updatedOrder)
            findNavController().navigate(R.id.action_debitedUpdatedFragment_to_debitedListFragment)
            showCustomToast("debited Updated Successfully")
        }
